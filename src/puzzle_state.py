...
class PuzzleState:
    ...
    def __init__(self):
        ...
        self._placements: Dict[str, PiecePlacement] = {}  # Map piece color to its placement
        self._occupied_indices: Set[int] = set()  # Set of all occupied position indices
    
    def place_piece(self, color: str, position_index: int, orientation_index: int, 
                   occupied_indices: Set[int]) -> bool:
